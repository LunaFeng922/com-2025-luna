...
function mousePressed() {
  ...
  if (
    ...
    let newWindow = window.open(
      "http://lunafeng922.github.io/com-2025-luna/maintoeyes/index.html"
    );
    window.close();
  }
  ...
  if (
    ...
    let newWindow = window.open(
      "http://lunafeng922.github.io/com-2025-luna/maintonose/index.html"
    );
    window.close();
  }
  //tomouth
  if (
    ...
    let newWindow = window.open(
      "http://lunafeng922.github.io/com-2025-luna/maintomouth/index.html"
    );
    window.close();
  }
}
